...
export const _homePlans = [...Array(3)].map((_, index) => ({
  license: ['UNIS Free', 'UNIS Professional', 'UNIS Ultimate'][index],
  commons: ['Account Manager', 'Simple Integration', 'Secure, Leading Technology'],
  options: ['Management Software', 'Design Resources', 'HR Suite', 'Powered by UNIS '],
  icons: [
